...
** Third Party Imports
These imports come from third party modules for things like widgets. Their location is the ./third_party/ directory.
...
+ ckeys: contains keyboard shortcuts that relate to clients (windows)
